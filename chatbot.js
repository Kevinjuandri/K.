...
function getChatbotResponse(message) {
    ...
    const programmerPatterns = [
        ...
        { pattern: /lo suka musik apa|lagu favorit lo apa|musik favorit lo apa/, response: "Gue suka dengerin musik elektronik dan pop, tapi juga suka musik akustik yang santai." },
